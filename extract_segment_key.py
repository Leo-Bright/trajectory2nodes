...
if __name__ == '__main__':
    extract_segment_key(road_segments_file='seattle/dataset/all_road_segments_dict.seattle',
                           way_tag_file='seattle/dataset/seattle_highway_tag.json',
                           key='tiger:name_type',
                           output_file='seattle/dataset/seattle_segments_tiger_name_type.json')
