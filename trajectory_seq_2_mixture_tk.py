...
if __name__ == '__main__':
    ...
    main(input_sequence='tokyo/sequence/tk_trajectory_transport_2_road_segment.sequence',
         output_mixture='tokyo/sequence/tk_trajectory_transport_2_sequence.mixture')